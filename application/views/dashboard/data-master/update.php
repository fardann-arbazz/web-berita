<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="<?= base_url('user/update') ?>">Update User</a></li>
        </ol>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="<?= base_url('user/updateUser/' . $users['id']) ?>" method="post">
